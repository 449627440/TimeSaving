...
public class TaskListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        TaskListAdapter.Zujian zujian = null;
        if(convertView==null){
            zujian = new TaskListAdapter.Zujian();
            convertView=layoutInflater.inflate(R.layout.activity_taskllist_adaper,null);
            ...
            zujian=(TaskListAdapter.Zujian)convertView.getTag();
        }
