...
public class ReceivedAdapter extends BaseAdapter {
    ...
    private List<Received> data;
    private LayoutInflater layoutInflater;
    private Context context;
    private static String TAG = "TaskListAdapter";


    public ReceivedAdapter(Context context, List<Received> data){
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ReceivedAdapter.Zujian zujian = null;
        if(convertView==null){
            zujian = new ReceivedAdapter.Zujian();
            ...
            zujian=(ReceivedAdapter.Zujian)convertView.getTag();
        }
